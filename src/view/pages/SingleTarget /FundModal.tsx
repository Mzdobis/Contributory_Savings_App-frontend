...
interface FundModalProps {
  close: () => void; // Define the close prop
  handleFundTarget: (payload: Record<string, number>) => Promise <undefined>
}

const FundModal: React.FC<FundModalProps> = ({ close, handleFundTarget }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      setLoading(true);
      const payload = {amountToFund: Number(amount)};
      await handleFundTarget(payload);
